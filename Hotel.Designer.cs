...
namespace WindowsFormsApplication1.HotelTableAdapters {
    ...
    public partial class HotelTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Hotel] ([HotelName]) VALUES (@HotelName);\r\nSELECT HotelID, Hot" +
                "elName FROM Hotel WHERE (HotelID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Hotel] SET [HotelName] = @HotelName WHERE (([HotelID] = @Original_H" +
                "otelID) AND ([HotelName] = @Original_HotelName));\r\nSELECT HotelID, HotelName FRO" +
                "M Hotel WHERE (HotelID = @HotelID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT HotelID, HotelName FROM dbo.Hotel";
        ...
        public virtual int Update(string HotelName, int Original_HotelID, string Original_HotelName, int HotelID) {
            if ((HotelName == null)) {
                throw new global::System.ArgumentNullException("HotelName");
            }
            else {
        ...
        public virtual int Update(string HotelName, int Original_HotelID, string Original_HotelName) {
            return this.Update(HotelName, Original_HotelID, Original_HotelName, Original_HotelID);
        }
    }
